function [theta, phi] = kahan_problem3(s_unit, t_unit, u, v)
...
theta = round([ ...
    kahan_problem2(s_unit, unit(u), w_unit1); ...
    kahan_problem2(s_unit, unit(u), w_unit2); ...
], 6);
phi = round([ ...
    kahan_problem2(t_unit, unit(v), w_unit1); ...
    kahan_problem2(t_unit, unit(v), w_unit2); ...
], 6);
